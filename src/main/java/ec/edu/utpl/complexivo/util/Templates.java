...
public class Templates {
    ...
    public static ComponentBuilder<?, ?> createTitleComponent(String label) {
        return cmp.horizontalList()
                ...
                .add(cmp.text(label).setStyle(bold22CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.CENTER))
                .newRow()
                .add(cmp.text("Gestion Vehicular").setStyle(bold12CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.CENTER))
                .newRow()
                .add(cmp.line())
                .newRow()
